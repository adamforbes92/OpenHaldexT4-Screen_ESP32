...
// *********************************************************************
  ...
  // global defines
  #define encoder_A_pin       pinRotaryA    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_B_pin       pinRotaryB    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_button_pin  pinRotarySW    // physical pin , use internal pullup
